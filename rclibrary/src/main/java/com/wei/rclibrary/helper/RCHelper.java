package com.wei.rclibrary.helper;
...
public class RCHelper {
    ...
    public void initAttrs(Context context, View targetView, AttributeSet attrs) {
        ...
        int roundCornerTopLeft =
                ta.getDimensionPixelSize(R.styleable.RCAttrs_round_corner_top_left, roundCorner);
        int roundCornerTopRight =
                ta.getDimensionPixelSize(R.styleable.RCAttrs_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft =
                ta.getDimensionPixelSize(R.styleable.RCAttrs_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight =
                ta.getDimensionPixelSize(R.styleable.RCAttrs_round_corner_bottom_right,
                        roundCorner);
        ta.recycle();
    ...
    public void drawableStateChanged(View view) {
        if (view instanceof RCAttrs) {
            ...
            if (strokeColorStateList != null && strokeColorStateList.isStateful()) {
                ...
                int stateColor =
                        strokeColorStateList.getColorForState(stateList, mDefaultStrokeColor);
